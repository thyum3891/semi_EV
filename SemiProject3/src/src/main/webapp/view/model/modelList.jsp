    ...
    <div class="main_right_box">
        ...
        <div class="main_right_sort">
            <div class="main_right_array">
                <a class="on" onclick="win.GoOrderType(this, '최근등록')">최근등록순</a>
                <a class="on" onclick="win.GoOrderType(this, '최저가')">최저가순</a>
                <a class="on" onclick="win.GoOrderType(this, '최고가')">최고가순</a>
            </div>
        </div>
...
<section id="content">
                ...
                <li name="data1">
                    <a data-ch="N" data-ce="N" data-in="N">
                        ...
                        <dl>
                            ...
                            <dd>
                                <button id="myBtn1" class="btn btn-primary btntransition">상세보기</button>
                            </dd>
                        </dl>
                    </a>
                </li>
            ...
            <div class="container content-space-1">
                <div class="row">
                    <div class="col-md-7 mb-7 mb-md-0">
                        <div class="pe-md-4">
                            <div class="card-pinned">
                                <img class="card-img" src="resources/img/main_01.jpg" alt="전기차 사진">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <!-- Heading -->
                        <!-- 구분/제조사 -->
                        <h4 id="car-manu" class="car-manu">[외제] > [테슬라]</h3>
                            <!-- 모델명 -->
                            <h2 id="car-name" class="car-name">2022 포르쉐 타이칸 GTS 스포츠 투리스모 </h2>
                            <div class="mb-5">
    ...
    <script>
        ...
        $("#myBtn1, #myBtn2, #myBtn3,#myBtn4, #myBtn5, #myBtn6, #myBtn7, #myBtn8, #myBtn9, #myBtn10, #myBtn11, #myBtn12, #myBtn13, #myBtn14,#myBtn15").click(function() {
            modal.style.display = "block";
